...
class SellerProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=SellerProfile
        fields=['id','user','seller_application_id','bussiness_name','address','email','mobile_number','gst_number','pan_number','account_number','ifsc_number','return_amount','iu_id','updated_profile']
    def __init__(self, *args, **kwargs):
        fields = kwargs.pop('fields', None)
        super().__init__(*args, **kwargs)
        if fields is not None:
